...
/****** Object:  Job [PullFromEPIC_HIBOutlookPlugin]    Script Date: 4/4/2018 1:31:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 4/4/2018 1:31:20 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'PullFromEPIC_HIBOutlookPlugin', 
		...
		@owner_login_name=N'photonuser', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [PullFromEPIC]    Script Date: 4/4/2018 1:31:21 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [PullFromEPIC_Merge]    Script Date: 4/4/2018 1:31:21 AM ******/
